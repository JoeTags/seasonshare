...
function min(_getLeafValues, getChildValues) {
  ...
  for (var _iterator = _rollupPluginBabelHelpers.createForOfIteratorHelperLoose(getChildValues()), _step; !(_step = _iterator()).done;) {
...
function max(_getLeafValues, getChildValues) {
  ...
  for (var _iterator2 = _rollupPluginBabelHelpers.createForOfIteratorHelperLoose(getChildValues()), _step2; !(_step2 = _iterator2()).done;) {
...
function extent(_getLeafValues, getChildValues) {
  ...
  for (var _iterator3 = _rollupPluginBabelHelpers.createForOfIteratorHelperLoose(getChildValues()), _step3; !(_step3 = _iterator3()).done;) {
...
function mean(getLeafValues) {
  ...
  for (var _iterator4 = _rollupPluginBabelHelpers.createForOfIteratorHelperLoose(getLeafValues()), _step4; !(_step4 = _iterator4()).done;) {

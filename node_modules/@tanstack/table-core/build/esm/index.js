    ...
    return {
      ...
      resetColumnSize: function resetColumnSize(columnId) {
        instance.setColumnSizing(function (_ref2) {
          _ref2[columnId];
              var rest = _objectWithoutPropertiesLoose(_ref2, [columnId].map(_toPropertyKey));
...
export { ColumnSizing, Expanding, Filters, Grouping, Headers, Ordering, Pagination, Pinning, RowSelection, Sorting, Visibility, buildHeaderGroups, columnFilterRowsFn, createTableInstance, defaultColumnSizing, expandRowsFn, flattenBy, functionalUpdate, globalFilterRowsFn, groupRowsFn, init, isFunction, isRowSelected, makeStateUpdater, memo, noop, paginateRowsFn, passiveEventSupported, propGetter, selectRowsFn, shouldAutoRemoveFilter, sortRowsFn };
